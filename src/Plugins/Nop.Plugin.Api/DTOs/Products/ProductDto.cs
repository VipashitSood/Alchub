...
namespace Nop.Plugin.Api.DTO.Products
{
    ...
    public class ProductDto : BaseDto
    {
        ...
        /// <summary>
        ///  Gets or sets the share url - pending.
        /// </summary>
        ...
        /// <summary>
        ///  Gets or sets the value which indicates product is in cureent customers favorite list or not. 
        /// </summary>
        ...
        [JsonProperty("grouped_product_base_varinats")]
        public IList<GroupedProductVariantBrifInfoModel> GroupedProductBaseVariants { get; set; }
    }
}

...
namespace Nop.Plugin.Api.DTO.OrderItems
{
    ...
    public class OrderItemDto : BaseDto
    {
        ...
        /// <summary>
        /// Gets or sets the IsReturnAllowed
        /// </summary>
        ...
        [JsonProperty("custom_attributes_xml")]
        public string CustomAttributesXml { get; set; }

        [JsonProperty("custom_attributes_description")]

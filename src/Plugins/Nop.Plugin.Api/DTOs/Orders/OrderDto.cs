...
namespace Nop.Plugin.Api.DTO.Orders
{
    ...
    public class OrderDto : BaseDto
    {
        public OrderDto()
        {
            ...
            SlotFeesList = new List<SlotWiseFeeDto>();
        ...
        /// <summary>
        ///  Gets or sets the order return request
        /// </summary>
        [JsonProperty("order_return_request")]
        public OrderReturnRequestDto OrderReturnRequests { get; set; }


        /// <summary>
        /// Gets or sets vendor wise delivery fee list
        /// </summary>
        [JsonProperty("vendor_wisedelivery_fees")]
        public IList<VendorWiseDeliveryFee> VendorWiseDeliveryFees { get; set; }

        /// <summary>
        /// Gets or sets vendor wise Tip fee list
        /// </summary>
        [JsonProperty("vendor_wise_tipfees")]
        public IList<VendorWiseTipFee> VendorWiseTipFees { get; set; }

        [JsonProperty("slot_fees_list")]
        public IList<SlotWiseFeeDto> SlotFeesList { get; set; }

        [JsonProperty("pickup_addresses")]

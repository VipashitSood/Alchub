...
{
    public static partial class NopCustomerApiDefaults
    {
        ...
        public static string OtpAttribute => "Otp";
        public static string IsRegistrationOtpVerifiedAttribute => "IsRegistrationOtpVerified";
        public static string TokenAttribute => "Token";
        public static string DeviceTypeAttribute => "DeviceType";
        public static string AppVersionAttribute => "AppVersion";
        public static string ProfilePicUrlAttribute => "ProfilePicUrl";
        public static string ReturnOrderPicUrlAttribute => "ReturnOrderPicUrl";
        public static string ProfileStatusAttribute => "ProfileStatus";
        /// <summary>
        ...
        public static string MobileNoAttribute => "MobileNo";
        ...
        /// <summary>
        /// Gets a name of generic attribute to store the value of 'ComparedProducts' (comma saperated ids)
        /// </summary>
        public static string ComparedProductsAttribute => "Api.ComparedProducts";

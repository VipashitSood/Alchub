...
using Nop.Plugin.Api.Services.Filter;
...
namespace Nop.Plugin.Api.Infrastructure
{
    ...
    public class DependencyRegister : INopStartup
    {
        ...
        public void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            //override api filter optimization
            services.AddScoped<IApiFilterOptimzationService, OverridenApiFilterOptimzationService>();
            //V1
            services.AddScoped<Nop.Plugin.Api.Factories.V1.ICatalogModelFactory, Nop.Plugin.Api.Factories.V1.CatalogModelFactory>();
        }
    }
}

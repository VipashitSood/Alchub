    ...
    public class ApiPlugin : BasePlugin
    {
        ...
        public override async Task InstallAsync()
        {
            ...
            await _localizationService.AddOrUpdateLocaleResourceAsync(new Dictionary<string, string>
            {
                ...
                { "Plugins.Api.Admin.Configuration.OtpRequiredOnRegistration", "OTP Required on registration" },
                { "Plugins.Api.Admin.Configuration.Restricted_PaymentMethodsSystemNames", "Restricted Payment methods" },
                { "Plugins.Api.Admin.Configuration.Restricted_PaymentMethodsSystemNames.Hint", "Add comma-separated payment method system names, you want to allow for a mobile app. Keep empty to load all available payment methods." },
            });

            //restricted payment methods
            var apiSettings = new ApiSettings();
            apiSettings.Restricted_PaymentMethodsSystemNames.Add("Payments.CheckMoneyOrder"); //default restrict to COD (CheckoutMoenyOrder)
            apiSettings.OtpRequiredOnRegistration = true; //default true
            ...
            if (apiRole == null)
            {
                ...
                {
                    Name = Constants.Roles.API_ROLE_NAME,
                    Active = true,
                    SystemName = Constants.Roles.API_ROLE_SYSTEM_NAME
                };

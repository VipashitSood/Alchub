...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class ProductSpecificationAttributesController : BaseApiController
    {
            ...
            Delta<ProductSpecificationAttributeDto> productSpecificaitonAttributeDelta)
        {
            ...
            await _customerActivityService.InsertActivityAsync("AddNewProductSpecificationAttribute", productSpecificationAttribute.Id.ToString());
            ...
            Delta<ProductSpecificationAttributeDto> productSpecificationAttributeDelta)
        {
            ...
            await _customerActivityService.InsertActivityAsync("EditProductSpecificationAttribute", productSpecificationAttribute.Id.ToString());
        ...
        public async Task<IActionResult> DeleteProductSpecificationAttribute([FromRoute] int id)
        {
            ...
            //activity log
            await _customerActivityService.InsertActivityAsync("DeleteProductSpecificationAttribute",
                                                   await _localizationService.GetResourceAsync("ActivityLog.DeleteProductSpecificationAttribute"),

...
namespace Nop.Plugin.Api.Controllers
{
    ...
    public class SpecificationAttributesController : BaseApiController
    {
            ...
            Delta<SpecificationAttributeDto> specificaitonAttributeDelta)
        {
            ...
            await _customerActivityService.InsertActivityAsync("AddNewSpecAttribute", await _localizationService.GetResourceAsync("ActivityLog.AddNewSpecAttribute"), specificationAttribute);
            ...
            Delta<SpecificationAttributeDto> specificationAttributeDelta)
        {
            ...
            await _customerActivityService.InsertActivityAsync("EditSpecAttribute", await _localizationService.GetResourceAsync("ActivityLog.EditSpecAttribute"), specificationAttribute);
        ...
        public async Task<IActionResult> DeleteSpecificationAttribute([FromRoute] int id)
        {
            ...
            //activity log
            await _customerActivityService.InsertActivityAsync("DeleteSpecAttribute", await _localizationService.GetResourceAsync("ActivityLog.DeleteSpecAttribute"), specificationAttribute);

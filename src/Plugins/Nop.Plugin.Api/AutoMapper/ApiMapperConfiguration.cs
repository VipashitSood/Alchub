...
namespace Nop.Plugin.Api.AutoMapper
{
    public class ApiMapperConfiguration : Profile, IOrderedMapperProfile
    {
        public ApiMapperConfiguration()
        {
            ...
            //mobile categories
            CreateMap<CategoryDto, CategoryHierarchyModel>();
            CreateMap<CategoryHierarchyModel, CategoryDto>();
            ...
            CreateMap<Country, CountryListResponse>();

            CreateMap<Currency, CurrencyDto>();

            CreateMap<Category, TopCategoryDto>();
            CreateMap<TopCategoryDto, Category>();
            CreateFeaturedProductMap();
            CreateDealsOfTheDayProductMap();
            CreateProductListMap();
            CreateFavoriteVendorMap();
        }
        ...
        private void CreateFeaturedProductMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<Product, FeaturedProductDto>()
                                      .IgnoreAllNonExisting()
                                      .ForMember(p => p.RequiredProductIds, o => o.Ignore());
        }

        private void CreateDealsOfTheDayProductMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<Product, DealsOfTheDayDto>()
                                      .IgnoreAllNonExisting()
                                      .ForMember(p => p.RequiredProductIds, o => o.Ignore());
        }

        private void CreateProductListMap()
        {
            AutoMapperApiConfiguration.MapperConfigurationExpression.CreateMap<Product, ProductListDto>()
                                      .IgnoreAllNonExisting()
                                      .ForMember(p => p.RequiredProductIds, o => o.Ignore());
        }

        private void CreateFavoriteVendorMap()
        {

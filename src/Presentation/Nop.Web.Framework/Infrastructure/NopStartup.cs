...
namespace Nop.Web.Framework.Infrastructure
{
    ...
    public class NopStartup : INopStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            /*Alchub Start*/
            //Alchub custom service
            services.AddScoped<IAlchubGeneralService, AlchubGeneralService>();
            services.AddScoped<ISlotService, SlotService>();
            services.AddScoped<ICategoryMarkupService, CategoryMarkupService>();
            services.AddScoped<IServiceFeeManager, ServiceFeeManager>();
            services.AddScoped<IGeoService, GeoService>();
            services.AddScoped<IDeliveryFeeService, DeliveryFeeService>();
            services.AddScoped<ITipFeeService, TipFeeService>();
            services.AddScoped<IMultiVendorService, MultiVendorService>();
            services.AddScoped<ITwillioService, TwillioService>();
            services.AddScoped<IApiFilterOptimzationService, ApiFilterOptimzationService>();
            services.AddScoped<IProductFriendlyUpcService, ProductFriendlyUpcService>();
            services.AddScoped<IAlchubSameNameProductService, AlchubSameNameProductService>();
            services.AddScoped<ICatalogService, CatalogService>();
            services.AddScoped<IOrderDispatchService, OrderDispatchService>();
            //Elastic Search
            services.AddScoped<IElasticsearchIndexCreator, ElasticsearchIndexCreator>();
            services.AddScoped<IElasticsearchManagerService, ElasticsearchManagerService>();

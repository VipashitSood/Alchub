...
namespace Nop.Web.Infrastructure
{
    ...
    public class NopStartup : INopStartup
    {
        ...
        public virtual void ConfigureServices(IServiceCollection services, IConfiguration configuration)
        {
            ...
            /*Alchub Start*/
            services.AddScoped<ISlotModelFactory, SlotModelFactory>();
            services.AddScoped<ICategoryMarkupModelFactory, CategoryMarkupModelFactory>();
            services.AddScoped<IDeliveryFeeModelFactory, DeliveryFeeModelFactory>();
            services.AddScoped<IMultiVendorModelFactory, MultiVendorModelFactory>();
            services.AddScoped<IOrderItemRefundService, OrderItemRefundService>();
            services.AddScoped<IVendorTimingService, VendorTimingService>();
            services.AddScoped<IFavoriteVendorService, FavoriteVendorService>();
            services.AddScoped<IFavoriteModelFactory, FavoriteModelFactory>();
            services.AddScoped<ISyncCatalogFactory, SyncCatalogFactory>();
            services.AddScoped<IProductFriendlyUpcModelFactory, ProductFriendlyUpcModelFactory>();
            services.AddScoped<IDispatchModelFactory, DispatchModelFactory>();
            /*Alchub End*/
        }

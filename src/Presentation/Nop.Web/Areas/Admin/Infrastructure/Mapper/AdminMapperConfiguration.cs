...
namespace Nop.Web.Areas.Admin.Infrastructure.Mapper
{
    ...
    public class AdminMapperConfiguration : Profile, IOrderedMapperProfile
    {
        ...
        /// Create zones maps 
        /// </summary>new
        protected virtual void CreateZonesMaps()
        {
        ...
        /// <summary>
        /// Create Category Markup maps 
        /// </summary>new
        protected virtual void CreateCategoryMarkupsMaps()
        {
            CreateMap<CategoryMarkup, CategoryMarkupModel>();

            CreateMap<CategoryMarkupModel, CategoryMarkup>();
        ...
        /// Create vendors maps 
        /// </summary>
        protected virtual void CreateTwillioSettingsMaps()
        {
            CreateMap<TwillioSettings, TwillioSettingsModel>()
                .ForMember(model => model.Enabled_OverrideForStore, options => options.Ignore())
                ...
                .ForMember(model => model.FromNumber_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.DefaultCountryCode_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.OrderPlacedBody_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.OrderItemsDispatchedBody_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.OrderItemsPickedUpBody_OverrideForStore, options => options.Ignore())
                .ForMember(model => model.OrderItemsDeliveredBody_OverrideForStore, options => options.Ignore());
            CreateMap<TwillioSettingsModel, TwillioSettings>();
        }

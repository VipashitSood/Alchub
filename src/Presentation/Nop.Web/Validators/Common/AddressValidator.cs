...
namespace Nop.Web.Validators.Common
{
    public partial class AddressValidator : BaseNopValidator<AddressModel>
    {
        ...
        //    RuleFor(x => x.GeoLocationCoordinates).NotEmpty().WithMessageAwait(localizationService.GetResourceAsync("Alchub.Account.Fields.GeoLocationCoordinates.Required"));
        //}
    }
}
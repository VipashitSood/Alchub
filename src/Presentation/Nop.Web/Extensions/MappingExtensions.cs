        ...
        public static Address ToEntity(this AddressModel model, Address destination, bool trimFields = true)
        {
            ...
            if (trimFields)
            {
                ...
                if (model.GeoLocation != null)
                    model.GeoLocation = model.GeoLocation.Trim();
                if (model.GeoLocationCoordinates != null)
                    model.GeoLocationCoordinates = model.GeoLocationCoordinates.Trim();
                /*Alchub End*/
            }
            ...
            /*Alchub Start*/
            destination.GeoLocation = model.GeoLocation;
            destination.GeoLocationCoordinates = model.GeoLocationCoordinates;
            destination.AddressTypeId = model.AddressTypeId;
            /*Alchub End*/

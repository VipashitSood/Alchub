...
namespace Nop.Web.Validators.Common
{
    public partial class AddressValidator
    {
            ...
            CustomerSettings customerSettings)
        {
            ...
            RuleFor(x => x.GeoLocationCoordinates)
                .NotEmpty()
                .WithMessageAwait(localizationService.GetResourceAsync("Alchub.Account.Fields.GeoLocationCoordinates.Required.SelectFromSuggetion"))

...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        //Alchub Start
        public static readonly PermissionRecord ManageMasterProducts = new() { Name = "Admin area. Manage Master Products", SystemName = "ManageMasterProducts", Category = "Catalog" };
        public static readonly PermissionRecord ManageCategoryMarkups = new() { Name = "Admin area. Manage CategoryMarkup", SystemName = "ManageCategoryMarkups", Category = "Catalog" };
        public static readonly PermissionRecord ManageDeliveryFee = new() { Name = "Admin area. Manage DeliveryFee", SystemName = "ManageDeliveryFee", Category = "Configuration" };
        public static readonly PermissionRecord ManageSlots = new() { Name = "Admin area. Manage Slots", SystemName = "ManageSlots", Category = "Configuration" };
        public static readonly PermissionRecord ManagePickupSlots = new() { Name = "Admin area. Manage Pickup Slots", SystemName = "ManagePickupSlots", Category = "Configuration" };
        public static readonly PermissionRecord ManageMultiVendors = new() { Name = "Admin area. Manage Multi Vendors", SystemName = "ManageMultiVendors", Category = "Customers" };
        public static readonly PermissionRecord ManageTwillioSettings = new() { Name = "Admin area. Manage Twillio Settings", SystemName = "ManageTwillioSettings", Category = "Configuration" };
        public static readonly PermissionRecord AccessMasterBulkImportExport = new() { Name = "Admin area. Access Master bulk import/export", SystemName = "AccessMasterBulkImportExport", Category = "Catalog" };
        public static readonly PermissionRecord AccessVendorProductActions = new() { Name = "Admin area. Access Vendor Create", SystemName = "AccessVendorProductActions", Category = "Catalog" };
        public static readonly PermissionRecord AccessVendorCreate = new() { Name = "Admin area. Access Master bulk import/export", SystemName = "AccessVendorCreate", Category = "Customers" };
        public static readonly PermissionRecord ManageProductFriendlyUpc = new() { Name = "Admin area. Manage Product friendly upc", SystemName = "ManageProductFriendlyUpc", Category = "Catalog" };
        public static readonly PermissionRecord ManageDispatch = new() { Name = "Admin area. Manage Dispatch", SystemName = "ManageDispatch", Category = "Sales" };
